...
import io.github.byzatic.tessera.editors.metricscore_gen3_tessera_project_builder.processing_manager.data_node.pipeline.routines.SupportReasonMessageGenerator;
import io.github.byzatic.tessera.editors.metricscore_gen3_tessera_project_builder.processing_manager.data_node.pipeline.routines.SupportVarNameGenerator;
...
public class PrometheusGetDataWorkflowRoutine {
    ...
    private String getDSL(Node node) {
        ...
        String dslBuilder = "//\n" +
                ...
                "\n" +
                "PROCESS FUNCTION PruneLabelsExceptBy(\n" +
                "\"DataId=" + dataId + "\",\n" +
                "\"ExceptedLabel=" + "reason" + "\",\n" +
                ") RETURN " + dataId + ";\n" +
                "\n" +
                "PROCESS FUNCTION ProcessReason(\n" +
                "\"DataId=" + dataId + "\",\n" +
                "\"IgnoreExistsReason=" + "False" + "\",\n" +
